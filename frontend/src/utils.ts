...
export function mapBackendRideToRide(backendRide: import('./types').BackendRide): import('./types').Ride {
  ...
  return {
    ...
    from: backendRide.start_address || resolveCoordsToName(backendRide.start_lon, backendRide.start_lat, 'Уралмаш'),
    to: backendRide.end_address || resolveCoordsToName(backendRide.end_lon, backendRide.end_lat, 'Кампус Новокольцовский'),
